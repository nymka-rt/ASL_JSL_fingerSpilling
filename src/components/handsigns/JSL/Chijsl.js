...
chiSign.addDirection(Finger.Index, FingerDirection.VerticalUp, 0.7);
...
chiSign.addDirection(Finger.Middle, FingerDirection.VerticalUp, 0.7);

//Ring
chiSign.addCurl(Finger.Ring, FingerCurl.FullCurl, 1);
chiSign.addDirection(Finger.Ring, FingerDirection.VerticalUp, 0.7);

//Pinky
chiSign.addCurl(Finger.Pinky, FingerCurl.NoCurl, 1);
chiSign.addDirection(Finger.Pinky, FingerDirection.VerticalUp, 0.7);
